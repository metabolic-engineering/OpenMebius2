        ...
        function warnings = calculateDerivedData(obj, experiments)
            ...
            for iExperiment = 1:numExperiments
                ...
                try
                    ...
                    if isempty(derivedData{iExperiment}.Enrichment)
                        warningGroups{iExperiment}(end + 1, 1) = ...
                            "Enrichment was not calculated for " + ...
                            experimentName + " because no valid " + ...
                            "biomass-corrected MDV fragments are " + ...
                            "available. Verify that ODi is lower than " + ...
                            "ODf and inspect the MS data.";
                    end
                catch ME
