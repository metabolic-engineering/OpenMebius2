classdef ExperimentSet < handle
        ...
        function obj = ExperimentSet(experimentInput, modelInput, options)
            ...
            arguments
                ...
                options.NotificationEmitter (1, 1) ...
                    ...
                    .NotificationEmitter = ...
                    openmebius.application.notification ...
                    .NotificationEmitter(Source = "ExperimentSet")
            end
    ...
    methods (Access = public)
        ...
        function applyMDVDerivedData(obj, expName, derivedData)
            ...
            obj.dataExp.(fieldName).tableMDVOptimization = ...
                derivedData.MDVOptimization;
    ...
    methods (Access = private)
        ...
        function workbook = createWorkbookData(obj, fieldName)
            ...
            workbook = openmebius.infrastructure.experiment ...
                ...
                MDVOptimization = getStoredTableOrEmpty( ...
                obj, fieldName, "tableMDVOptimization"), ...
    ...
    methods (Access = protected)
        ...
        function updateMsg(obj, text, level, ~)
            ...
            normalizedLevel = openmebius.core.notification.Severity ...
                .normalize(level);
