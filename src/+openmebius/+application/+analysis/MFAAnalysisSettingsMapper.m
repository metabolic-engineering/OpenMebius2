classdef MFAAnalysisSettingsMapper
    ...
    methods (Static)
        ...
        function result = tryFromBatchConfig(config)
            ...
            settings = openmebius.application.analysis ...
                ...
                .MFAAnalysisSettingsMapper.mapWorkerCount(config), ...
    ...
    methods (Static, Access = private)
        ...
        function workerCount = mapWorkerCount(config)

            defaults = openmebius.domain.batch.BatchConfig ...
                .defaultConfig();
            workerCount = defaults.CIConf.grid.workerCount;

            if isfield(config, 'CIConf') && ...
                    isstruct(config.CIConf) && ...
                    isfield(config.CIConf, 'grid') && ...
                    isstruct(config.CIConf.grid) && ...
                    isfield(config.CIConf.grid, 'workerCount') && ...
                    ~isempty(config.CIConf.grid.workerCount)
                workerCount = config.CIConf.grid.workerCount;
            end
