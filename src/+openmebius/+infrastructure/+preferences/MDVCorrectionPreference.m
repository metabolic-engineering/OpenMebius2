classdef MDVCorrectionPreference < handle
    % MDVCORRECTIONPREFERENCE Persists the natural-isotope correction method.

    properties (Constant)
        DefaultMethod = "skew"
        SupportedMethods = ["matrix", "skew", "least-squares"]
        ...
        function method = validateMethod(obj, method)
            ...
            if isempty(method) || ~isscalar(method) || ...
                ...
                error( ...
                    ...
                    "Unknown natural-isotope correction method '%s'.", ...
                    char(join(method, ", ")));
            end
