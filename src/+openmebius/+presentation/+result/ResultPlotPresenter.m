    ...
    methods (Access = private)
        ...
        function [plotData, notification] = ...
            ...
            try
                ...
                alpha = double(gridSearch.alpha);
                bestFit = double(data.fluxFwd(reactionIndex));
                fvaLowerBound = double( ...
                    data.fluxVariability.fluxLBFwd(reactionIndex));
                fvaUpperBound = double( ...
                    data.fluxVariability.fluxUBFwd(reactionIndex));
                lowerBound = NaN;
                upperBound = NaN;
            ...
            if ~any(valid) || ...
                    ...
                    ~isscalar(alpha) || ~isfinite(alpha) || alpha < 0 || ...
                    ~isscalar(fvaLowerBound) || ...
                    ~isfinite(fvaLowerBound) || ...
                    ~isscalar(fvaUpperBound) || ...
                    ~isfinite(fvaUpperBound) || ...
