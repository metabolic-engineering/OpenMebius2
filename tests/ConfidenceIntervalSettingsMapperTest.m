classdef ConfidenceIntervalSettingsMapperTest < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function mapsCanonicalBatchConfiguration(testCase)
            ...
            testCase.verifyEqual( ...
                settings.GridSearchSettings.WorkerCount, ...
                config.CIConf.grid.workerCount);
            testCase.verifyEqual( ...
                settings.MonteCarloSettings.WorkerCount, ...
                config.CIConf.grid.workerCount);
            testCase.verifyEqual( ...
                settings.GridSearchSettings.MaximumTrial, 15);
            testCase.verifyEqual( ...
        ...
        function mapsConfiguredWorkersToBothConfidenceMethods(testCase)
            ...
            testCase.verifyEqual( ...
                settings.MonteCarloSettings.WorkerCount, 7);
            testCase.verifyEqual( ...
                settings.GridSearchSettings.WorkerCount, 7);
