classdef ResultLocationTest < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function manifestFileCorrespondsToResultId(testCase)
            ...
            testCase.verifyEqual( ...
                resultLocation.manifestFile("batch-1"), ...
                fullfile(resultDirectory, "batch-1.manifest.json"));
            testCase.verifyEqual( ...
                resultLocation.resultArtifactFiles("batch-1"), ...
                [fullfile(resultDirectory, "batch-1.h5"); ...
                 fullfile(resultDirectory, "batch-1.manifest.json")]);
