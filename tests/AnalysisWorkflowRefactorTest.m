classdef AnalysisWorkflowRefactorTest < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function monteCarloFailureReportsExceptionDiagnostic(testCase)

            workflow = openmebius.mfa.ConfidenceIntervalWorkflow();
            problem = AnalysisWorkflowRefactorTest.createProblem();
            observer = helpers.AnalysisMessageObserverStub();
            monteCarloSettings = openmebius.mfa ...
            ...
            errorMessages = observer.Messages( ...
                observer.Levels == "error");
            testCase.verifyTrue(result.IsError);
            testCase.verifyNumElements(errorMessages, 1);
            testCase.verifySubstring( ...
                errorMessages(1), ...
            "[OpenMebius2:MonteCarloCI:MethodNotImplemented]");
            testCase.verifySubstring( ...
                errorMessages(1), ...
            "MonteCarloConfidenceIntervalSolver.validateInputs");
            testCase.verifySubstring(errorMessages(1), "line ");
