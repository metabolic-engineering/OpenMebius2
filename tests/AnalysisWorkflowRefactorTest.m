classdef AnalysisWorkflowRefactorTest < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function fluxAnalysisConstructsWithComposedDependencies(testCase)
            ...
            testCase.verifyTrue( ...
                findprop(analysis, 'AnalysisRunScope').Dependent);
            testCase.verifyClass( ...
            ...
            testCase.verifyClass( ...
                analysis.Dependencies.InitialFluxApplicationWorkflow, ...
                ['openmebius.application.analysis.' ...
            ...
            testCase.verifyClass( ...
                analysis.Dependencies.MFAObjectiveFactory, ...
                'openmebius.mfa.MFAObjectiveFactory');
            testCase.verifyClass( ...
                analysis.Dependencies.MFAIterationService ...
                .ObjectiveFactory, ...
                'openmebius.mfa.MFAObjectiveFactory');
            testCase.verifyClass( ...
