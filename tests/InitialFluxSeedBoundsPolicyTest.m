classdef InitialFluxSeedBoundsPolicyTest < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function createsNetFluxBoundsForReversibleFreeEfflux(testCase)
            ...
            [lowerBounds, upperBounds, matrix, rightHandSide, ...
                measurementBounds] = policy.apply( ...
                [0; 0], ...
                [10; 10], ...
                profile, ...
                ReversibleReactionIndices = [1, 2]);

            testCase.verifyEqual(lowerBounds, [0; 0]);
            testCase.verifyEqual(upperBounds, [10; 10]);
            testCase.verifyEqual(matrix, [1, -1; -1, 1]);
            testCase.verifyEqual(rightHandSide, [8; -2]);
            testCase.verifyEqual(measurementBounds, [2, 8]);
