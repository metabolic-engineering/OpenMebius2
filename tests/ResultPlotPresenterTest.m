classdef ResultPlotPresenterTest < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function presentsExitflagPieForSelectedResult(testCase)
            ...
            context = testCase.context();
            context.SelectionSource = "SubTable";
            context.SubPlotType = "exitflag-pie";
            ...
            testCase.verifyEqual( ...
                viewModel.SubPlot.Kind, ...
                "optimization-exitflag-pie");
            testCase.verifyEqual( ...
                viewModel.SubPlot.ExitFlags, [-2; 0; 1]);
            testCase.verifyEqual(viewModel.SubPlot.Counts, [1; 1; 2]);
            testCase.verifyEqual( ...
                viewModel.SubPlot.Labels, ...
                [ ...
                "Exitflag -2: 1 (25.0%)"; ...
                "Exitflag 0: 1 (25.0%)"; ...
                "Exitflag 1: 2 (50.0%)"]);
            testCase.verifyEqual( ...
                viewModel.SubPlot.Title, ...
                "Exitflag by iteration: First");
            testCase.verifyEmpty(viewModel.Notification);

        end

        function presentsExitflagPieForSelectedFlux(testCase)
            ...
            testCase.verifyEqual( ...
                ...
                "optimization-exitflag-pie");
            testCase.verifyEqual( ...
                viewModel.SubPlot.ExitFlags, [-1; 1]);
            testCase.verifyEqual(viewModel.SubPlot.Counts, [1; 2]);
        ...
        function presentsGridSearchProfile(testCase)
            ...
            testCase.verifyEqual( ...
                viewModel.SubPlot.XLimits, [0.4, 1.6], ...
                AbsTol = 1e-12);
            testCase.verifyEqual( ...
