classdef ExperimentEditServiceTest < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function saveAllPersistsLatestExperimentTables(testCase)

            fixture = ExperimentEditServiceTest.importFixture();
            cleanup = onCleanup( ...
                @() ExperimentEditServiceTest ...
            ...
            reloaded = openmebius.application.experiment ...
                ...
                .fromDirectory(fixture.Directory), ...
                fixture.ImportResult.Experiments.getModel());
            reloadedCleanup = onCleanup(@() delete(reloaded));
            savedInfo = reloaded.getInfoTable();
            savedUptake = reloaded.getUptakeTable();
            savedTracer = reloaded.getTracerTable();
            testCase.verifyEqual( ...
                savedInfo{1, "mu"}, ...
                infoTable{1, "mu"}, "AbsTol", 1e-12);
            testCase.verifyEqual( ...
                savedUptake{1, 1}, ...
                uptakeTable{1, 1}, "AbsTol", 1e-12);
            testCase.verifyEqual( ...
                savedTracer{1, 1}, ...
                tracerTable{1, 1});
            testCase.verifyTrue(any(contains( ...
                result.Messages, "saved before batch execution")));

        end % saveAllPersistsLatestExperimentTables
