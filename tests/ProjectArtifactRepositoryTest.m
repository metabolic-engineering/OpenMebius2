classdef ProjectArtifactRepositoryTest < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function loadUsesInjectedExperimentRepository(testCase)
            ...
            recoveryService = helpers.ResultBatchRecoveryServiceStub();
            recoveryService.RecoveredIDs = "bat_recovered";
            ...
            repository = openmebius.infrastructure.project ...
                ...
                ResultBatchRecoveryService = recoveryService);
            ...
            testCase.verifyEqual(recoveryService.RecoverCount, 1);
            testCase.verifyEqual( ...
                recoveryService.Batch, batchRepository.Batch);
            testCase.verifyEqual( ...
                recoveryService.Result, resultRepository.Result);
            testCase.verifyEqual(numel(artifacts.Messages), 5);
