classdef MFAProblemTest < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function separatesFixedFluxBoundsIntoEqualities(testCase)
            ...
            testCase.verifyEqual( ...
                inequalityMatrix, [0, -1; 0, 1]);
            testCase.verifyEqual(inequalityRightHandSide, [1; 1]);
            testCase.verifyEqual(equalityMatrix, [1, 0]);
            testCase.verifyEqual(equalityRightHandSide, 0);
