    ...
    methods (Test)
        ...
        function reportsSuccessfulInstationaryResult(testCase)
            ...
            testCase.verifyEqual( ...
                ...
                "completed. RSS: 1.0000. FiniteDifferenceStepSize: " + ...
                string(1e-6) + ".");

        end

        function formatsRSSAndElapsedTime(testCase)

            observer = helpers.AnalysisMessageObserverStub();
            reporter = MFAIterationReporterTest.reporter(observer);
            result = MFAIterationReporterTest.result( ...
                ObjectiveValue = 458.45678);
            ...
            testCase.verifyEqual( ...
                observer.Messages, ...
                "Nonlinear optimization completed. RSS: 458.4568. " + ...
