classdef OpenMebius2SourceSyncTest < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function legacyParserSignatureIsSupported(testCase)

            parser = helpers.LegacyPlainTextCodeParserStub();
            callbackInfo = struct( ...
                AssignedCallbacks = [], ...
                Children = struct.empty);
            expected = OpenMebius2SourceSyncTest.parseCodeData( ...
                parser, callbackInfo, "startupFcn", true, "Standard");

            testCase.verifyEqual( ...
                expected.ComponentCallbackAssignments, callbackInfo);
            testCase.verifyEqual(expected.StartupName, "startupFcn");
            testCase.verifyTrue(expected.IsSingleton);
    ...
    methods (Static, Access = private)
        ...
        function [actual, expected] = appModelCodeData( ...
            ...
            expected = OpenMebius2SourceSyncTest.parseCodeData( ...
                parser, callbackInfo, startupName, isSingleton, ...
